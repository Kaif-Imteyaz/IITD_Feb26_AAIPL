...
class QAgent(object):
    def __init__(self, **kwargs):
        ...
        model_name = str(Path(__file__).parent.parent / "sft_checkpoints" / "final_question_merged")

        # self.base_model_path = "/root/.cache/huggingface/hub/models--Qwen--Qwen2.5-14B-Instruct/snapshots"
